...
app = FastAPI(title="ChainMind AI Agent API (Stellar)", version="1.0.0")
...
async def health_check():
    return {"status": "ChainMind AI Agent is online", "agent": "ChainMind", "chain": "Stellar Testnet"}
...
async def simulate_contract(
    ...
    # 10. Record on Stellar (Audit Trail)
    ...
    # 11. Update Reputation on Stellar
...
async def agent_stats():
    ...
    return {
        ...
        "identity_reg":  os.getenv("AGENT_IDENTITY_REGISTRY_ID"),
        "earnings":      earnings
    }
